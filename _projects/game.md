...
subtitle: A small game in Unity3D I'm currently working on.
---
...
Although I am pretty satisfied with the results I achieved so far with the environment arts, I definitely got lost and tunnel visioned so much that so far environment art is all I got in the game.

![](./images/game_demo1.gif)
...
For now I will probably halt the development, but who knows when I will get to pull it back from the archives...

***

### More screenshots I took during development

![](./images/game_demo3.gif)

<img src="./images/beach_view.png" alt="drawing" width="600"/>
